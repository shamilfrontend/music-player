<template>
  <div class="play">
    ...
    <div class="content">
        ...
        <div v-show="isShowMusicList" class="music-list">
          <ul>
            <li
              ...
              :class="{ activeColor: index === audio.index}"
            >
              {{ (index + 1) +'. &nbsp;'+ item.name}}
            </li>
          </ul>
      ...
      <img
        @click.stop.prevent="isShowSkinColors = false; isShowMusicList = false"
        :src="audio.musicImgSrc || (musicData[0] && musicData[0].musicImgSrc)"
        alt="microzz.com"
      >
      <div
        @click.stop.prevent="isShowSkinColors = false; isShowMusicList = false"
      ...
      <div :class="{'equalizer': true, 'equalizer_paused': !isPlaying}"></div>
      ...
      <div class="skin">
        ...
        <div
          @click="showSkinColor"
          :class="{'icon-skin-red': skinColor === '#B72712','icon-skin-blue': skinColor === '#1565C0','icon-skin-black': skinColor === '#212121','icon-skin-green': skinColor === '#1B5E20'}"
          class="icon-skin"
        ></div>
      </div>
    </div>
  ...
  .play {
    ...
    .content {
      ...
      .skin {
        ...
        .icon-skin-red {
          background-image: url('./icons/skinRed.svg');
        }

        .icon-skin-green {
          background-image: url('./icons/skinGreen.svg');
        }

        .icon-skin-blue {
          background-image: url('./icons/skinBlue.svg');
        }

        .icon-skin-black {
          background-image: url('./icons/skinBlack.svg');
        }
