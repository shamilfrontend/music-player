  ...
  <div class="music-app">
    <div class="cover">
      <div class="cover-title">
        <p class="title">Shamil Frontend</p>
      </div>
    ...
    <div class="content">
      <div class="content-header">
        <span class="content-title">Лучшие песни</span>
        <button class="btn-all">Все песни</button>
      </div>
      ...
      <div class="content-header">
        <span class="content-title">Альбомы</span>
        <button class="btn-all">Все альбомы</button>
      </div>

      <div class="album-list">
        <div class="album-wrapper">
          <img
            src="https://images.unsplash.com/photo-1497911174120-042e550e7e0a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2238&q=80"
            alt="album"
            class="album-cover"
          />
          <div class="list-item-info">
        ...
        <div class="album-wrapper">
          <img
            src="https://images.unsplash.com/photo-1565021009519-22da0e21f65c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2250&q=80"
            alt="album"
            class="album-cover"
          />
          <div class="list-item-info">
        ...
        <div class="album-wrapper">
          <img
            src="https://images.unsplash.com/photo-1574155088851-0c770818ba40?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2250&q=80"
            alt="album"
            class="album-cover"
          />
          <div class="list-item-info">
    ...
    <div class="player">
      <button class="btn btn-extend" @click="handlePlayerScreenToggle" />

      <div class="player-top-content">
        <img
          class="list-item-image"
          src="https://images.unsplash.com/photo-1588465023238-f8951f48a1ff?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2250&q=80"
          alt="song"
        />
    ...
    <div ref="playerScreen" :class="playerScreenClasses">
      <button class="btn btn-close" @click="handlePlayerScreenToggle" />
      ...
      <div class="song-info">
        <p class="song-title">Let It Happen</p>
      ...
      <div class="sound-bar">
        <button class="btn btn-volume-down" />

        <div class="proggres-bar volume">
          <span class="progress"></span>
        </div>

        <button class="btn btn-volume-up" />
      </div>
    </div>
  </div>
</template>
...
.cover {
  ...
  background-image: url('https://img.lostpic.net/orig_images/5/f/1/5f1c124474e492154d100ecf8071addf.jpg');
